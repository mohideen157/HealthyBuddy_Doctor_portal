...
@php
	...
	if(App\User::isDoctor()){
		$store_article = 'doctor.article.store';
		$update_article = 'doctor.article.update';
	}
	else{
		$store_article = 'admin.article.store';
		...
		<div class="col-md-12 col-xs-12 article-panel">
		   <div class="panel panel-default">
	            <div class="panel-heading">
					<h3 class="panel-title" style="font-size:18px;display: inline-block;">@if(isset($article)) Update Article @else Add Article @endif</h3>
				...
				<div class="panel-body">
			        <div id="collapse">
						<form action="@if(isset($article)){{ route($update_article, $article->id) }} @else{{ route($store_article) }} @endif" method="POST" enctype="multipart/form-data">
