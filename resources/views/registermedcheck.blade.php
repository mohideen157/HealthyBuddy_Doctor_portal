        ...
        <div>
            ...
            <div class="login_wrapper">
                <div  class="row">
                    ...
                    @endif
                       {!! Form::open(['method' => 'POST', 'url' =>'registermedcheckuser','enctype'=>"multipart/form-data"]) !!}
                            ...
                            <div class="row">
                                 <div class="col-md-6">
                                <div class="form-group">
                                            <input type="text" name="country_code" maxlength="10"   class="form-control" value="{{old('country_code')}}" nullable placeholder="India (+91)" readonly />
                                        </div>
                                </div>
                                 <div class="col-md-6">
                                 <div class="form-group">                                           
                                           <input type="text" name="mobile_no" maxlength="10"   class="form-control" value="{{ $phone }}" placeholder=" Phone  *" required />
                                        </div>
                                </div>
