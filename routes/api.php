...
Route::get('aws-setting','App\Http\Controllers\Common\PatientProfileController@aws_setting');
Route::post('device-json','App\Http\Controllers\Common\PatientProfileController@DeviceJson');
Route::get('device-json','App\Http\Controllers\Common\PatientProfileController@Getdevicejson');
Route::group(['prefix' => '/rest/V1', 'middleware' => 'api'], function() {
	...
	Route::group(['namespace' => 'App\Http\Controllers'], function(){
		...
		//SendPDF
		Route::post('SendPDFemailWoo', 'SendPDF\SendPDFController@SendPDFemailWoo');
		Route::get('DownloadPDF', 'SendPDF\SendPDFController@DownloadPDF');
	});

	//Medcheck Device APIs
	Route::group(['middleware' => 'jwtauth', 'namespace' => 'App\Http\Controllers'], function(){
		
		//Route::post('authenticate/registermedcheckuserOLD', 'AppAuthController@registermedcheckuserOLD');
		//Route::post('authenticate/registermedcheckuser', 'MedcheckDb2DbSyncApiController@registermedcheckuser');
		//Medcheck DB2DB Sync
		Route::post('authenticate/SyncMedCheckUsers', 'MedcheckDb2DbSyncApiController@SyncMedCheckUsers');
		//Route::post('authenticate/SyncMedCheckBp', 'MedcheckDb2DbSyncApiController@SyncMedCheckBp');
		Route::post('authenticate/SyncMedCheckBp/{id}', 'MedcheckDb2DbSyncApiController@SyncMedCheckBp');
		//Route::post('authenticate/SyncMedCheckHr','MedcheckDb2DbSyncApiController@SyncMedCheckHr');
		Route::post('authenticate/SyncMedCheckHr/{id}','MedcheckDb2DbSyncApiController@SyncMedCheckHr');
		//Route::post('authenticate/SyncMedCheckWeightScale','MedcheckDb2DbSyncApiController@SyncMedCheckWeightScale');
		Route::post('authenticate/SyncMedCheckWeightScale/{id}','MedcheckDb2DbSyncApiController@SyncMedCheckWeightScale');
		//Route::post('authenticate/SyncMedCheckSpo2Data','MedcheckDb2DbSyncApiController@SyncMedCheckSpo2Data');
		Route::post('authenticate/SyncMedCheckSpo2Data/{id}','MedcheckDb2DbSyncApiController@SyncMedCheckSpo2Data');
		//Route::post('authenticate/SyncMedCheckTemparatureData','MedcheckDb2DbSyncApiController@SyncMedCheckTemparatureData');
		Route::post('authenticate/SyncMedCheckTemparatureData/{id}','MedcheckDb2DbSyncApiController@SyncMedCheckTemparatureData');
		//Route::post('authenticate/SyncMedCheckGlucoseData','MedcheckDb2DbSyncApiController@SyncMedCheckGlucoseData');
		Route::post('authenticate/SyncMedCheckGlucoseData/{id}','MedcheckDb2DbSyncApiController@SyncMedCheckGlucoseData'); 
	
		//INSERT MEDCHECK DEVICE READINGS 
		Route::post('authenticate/InsertuserBPdata','MedcheckDb2DbSyncApiController@InsertuserBPdata');
		Route::post('authenticate/InsertuserWeightscaledata','MedcheckDb2DbSyncApiController@InsertuserWeightscaledata');
		Route::post('authenticate/InsertuserGlucosedata','MedcheckDb2DbSyncApiController@InsertuserGlucosedata');
		Route::post('authenticate/InsertuserSPO2','MedcheckDb2DbSyncApiController@InsertuserSPO2');
		Route::post('authenticate/InsertuserECGdata','MedcheckDb2DbSyncApiController@InsertuserECGdata');
		Route::post('authenticate/InsertuserTemparaturedata','MedcheckDb2DbSyncApiController@InsertuserTemparaturedata');
		
		//Medcheck GET USER READINGS
		Route::get('authenticate/GetuserAlldata','MedcheckDb2DbSyncApiController@getuseralldata');
		Route::get('authenticate/GetuserBPdata','MedcheckDb2DbSyncApiController@getuserbpdata');
		Route::get('authenticate/GetuserWeightscaledata','MedcheckDb2DbSyncApiController@getuserweightscaledata');
		Route::get('authenticate/GetuserGlucosedata','MedcheckDb2DbSyncApiController@getuserglucosedata');
		Route::get('authenticate/GetuserSPO2','MedcheckDb2DbSyncApiController@getuserspo2');
		Route::get('authenticate/GetuserECGdata','MedcheckDb2DbSyncApiController@getuserecgdata');
		Route::get('authenticate/GetuserTemparaturedata','MedcheckDb2DbSyncApiController@getusertemparaturedata');
		Route::get('authenticate/Getusersdata/{id}','MedcheckDb2DbSyncApiController@getusersdata');

		//Symptomschecker APIs
		Route::post('symptomschecker/InsertPatientCovid19','API\Patient\SymptomscheckController@InsertPatientCovid19');
		Route::get('symptomschecker/GetPatientCovid19Data','API\Patient\SymptomscheckController@GetPatientCovid19Data');
	...
	Route::group(['middleware' => 'jwtauth', 'namespace' => 'Myaibud\Controllers'], function(){
		...
		Route::group(['prefix' => 'patient'], function() {
			...
			Route::post('upsertHraBandData', 'API\Patient\PatientHealthProfileController@upsertPatientHraBandData');
             Route::post('diet-plan', 'API\Patient\PatientController@dietplanlist');
            Route::post('heart-rate-test', 'API\Patient\PatientController@Heratratetest');
            Route::get('get-heart-rate-test', 'API\Patient\PatientController@getheartratetest');
            Route::post('blood-pressure', 'API\Patient\PatientController@bloodpressure');
            Route::get('blood-pressure', 'API\Patient\PatientController@getbloodpressure');
            Route::post('sleep', 'API\Patient\PatientController@Sleep');
            Route::get('sleep', 'API\Patient\PatientController@getsleep');
            Route::get('sleep-history', 'API\Patient\PatientController@Sleephistory');
            Route::post('heart-rate', 'API\Patient\PatientController@Heratrate');
            Route::get('heart-rate', 'API\Patient\PatientController@getheartrate');
			...
			Route::get('profile/hhi', 'API\Patient\PatientController@get_hhi');
			...
			Route::post('healthProfile/padometer', 'API\Patient\PatientHealthProfileController@upsertPadoMeterData');
             Route::get('healthProfile/padometer-history', 'API\Patient\PatientHealthProfileController@PadometerHistory');
			...
			// new route for get and set medical report
			Route::post('healthProfile/set-medical-report', 'API\Patient\PatientHealthProfileController@setMedicalReport');
			Route::get('healthProfile/get-medical-report', 'API\Patient\PatientHealthProfileController@getMedicalReport');

			Route::post('healthProfile/set-padometer-steps', 'API\Patient\PatientHealthProfileController@setPadameterSteps');
			Route::get('healthProfile/get-padometer-steps', 'API\Patient\PatientHealthProfileController@getPadameterSteps');
			Route::get('healthProfile/padometer-steps', 'API\Patient\PatientHealthProfileController@PadameterSteps');
			...
			Route::post('event', 'API\HistoryController@Eventpost');
			Route::get('event', 'API\HistoryController@Eventget');
