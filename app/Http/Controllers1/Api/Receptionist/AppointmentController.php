...
class AppointmentController extends Controller
{
    ...
    public function index(){
		try{
			...
			$appointments = DoctorAppointments::where('doctor_id', $doc_receptionist->doctor_id)
	...
	public function cancel(Request $request){
		try{
			...
			if ($appointment->doctor_id != $doc_receptionist->doctor_id) {
			...
			try{
				...
				$credit_log->remarks = "Refund for cancelled Appointment ID - ".$appointment->shdct_appt_id;
