...
class PatientProfileController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $user =  User::with('patientProfile')->where('organisation_id',Auth::id())
                        ->find($id);
        $date = null;
        $synched_ids = [];
        ...
        if($user)
        {
            ...
            return view('caregiver.patient.show', compact('user', 'bp', 'arrhythmia', 'arterial_age', 'date', 'synched_ids', 'nutritions', 'afib', 'rpwv', 'patient_health_profile_changed_date', 'patient_history_change_date', 'nutrition_change_date', 'hr','HHI', 'calories'));
        }
