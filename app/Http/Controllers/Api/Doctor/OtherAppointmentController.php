...
class OtherAppointmentController extends Controller
{
    public function index(){
		try{
			...
			foreach ($appointments as $app) {
				...
				$profile_image = '';		
				if(isset($pat_user->profile_image))
				$profile_image = URL::to('/').($pat_user->profile_image)?$pat_user->profile_image:'';
				
				$shdct_user_id = '';		
				if(isset($pat_user->shdct_user_id))
				$shdct_user_id = ($pat_user->shdct_user_id)?$pat_user->shdct_user_id:'';
