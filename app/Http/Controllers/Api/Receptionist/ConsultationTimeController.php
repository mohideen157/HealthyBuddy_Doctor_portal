...
class ConsultationTimeController extends Controller
{
	...
	public function index(){
		try{
			...
			$timeslots = DoctorTimeSlots::where('doctor_id', $id)->whereIn('id', $invalid_slots)->get();
	...
	public function update(Request $request){
		try{
			...
			$user_id = $doc_receptionist->doctor_id;

			$doctor_timeslots = DoctorTimeSlots::where('doctor_id', $user_id)->get();
