...
class PatientHealthProfileController extends Controller
{
    ...
    {
        $medication = $this->getPatienActivetHealthRecord()->where('parent_key', '=', 'medication')->where('child_key', '=', NULL)->first();
        if (!empty($medication)) {
            return response()->json([
                'success' => true,
                'data' => $medication
    ...
    public function getExcerciseData(Request $request){
        ...
        return ExcerciseResource::collection($excercises)->additional(['success' => true, 'message' => 'Excercise Data']);
    }
    ...
    public function setCaloriesTarget(Request $request){
        ...
        try 
        {
            $calories_create = PatientHealthProfile::where('value', $request->date)->whereParentKey('calories')->first();
            if ($calories_create) {
  ...
  //   }
    ...
    public function upsertPadoMeterData(Request $request)
    {
        ...
        try {
            ...
            if($padometer){
                $padometer->extra_info = $request->extra_info;
                $padometer->save();
            }else{
